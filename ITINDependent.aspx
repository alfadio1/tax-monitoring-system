...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ITINDependent.aspx.cs" Inherits="ITINDependent" %>
...
<head runat="server">
    <title>ITIN Dependent Information</title>
    ...
    <div>
        <table style="position:absolute;top:200px;left:350px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtpassportedate" CssClass="boxes" runat="server" OnTextChanged="txtpassportedate_TextChanged"></asp:TextBox>
                </td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblvisano" CssClass="boxes2" Text="Tax Number" runat="server"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td style="height: 27px">
                    <asp:Label ID="lblvisaedate" CssClass="boxes2" Text="TaxPayDate" runat="server"></asp:Label>
                </td>
                <td style="height: 27px">
            ...
            <tr>
                ...
                <td style="height: 26px">
                 ...
                 <td>
                  <asp:Label ID="lblmsg2" CssClass="text" runat="server" ForeColor="Aquamarine" Text="mm/dd/yyy"></asp:Label>
                </td>
                <td>
        ...
        <table style="position:absolute;top:510px;left:520px;">
            <tr>
                <td>
